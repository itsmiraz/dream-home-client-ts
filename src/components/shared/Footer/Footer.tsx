...
const Footer = () => {
    return (
        <footer className="px-4 divide-y bg-primary-2 rounded-xl">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <Image src={logo} alt='dream home logo' className='w-60' />
                    <p className='base-light'>Email: info@dreamhomes.com</p>
                    <p className='base-light'>Phone: +1 829 723 230</p>
                </div>
